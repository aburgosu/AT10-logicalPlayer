...
public class GeneralSearchPanel extends CustomPanelSecond {
    ...
    public GeneralSearchPanel() {
        ...
        comboBoxMimeType.setModel(new DefaultComboBoxModel(new String[] {"All","Audio", "Video", "Image", "Application"}));
        ...
        CustomLabel labelHidden = new CustomLabel("Include (hidden):");
        ...
        CustomLabel lblReadOnly = new CustomLabel("Include (read-only):");
